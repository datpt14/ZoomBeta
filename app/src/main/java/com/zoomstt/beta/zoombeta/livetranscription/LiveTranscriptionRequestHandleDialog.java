package com.zoomstt.beta.zoombeta.livetranscription;
...
public class LiveTranscriptionRequestHandleDialog extends Dialog implements View.OnClickListener {
    ...
    public static void show(MyMeetingActivity myMeetingSSS, String userName) {

        LiveTranscriptionRequestHandleDialog dialog = new LiveTranscriptionRequestHandleDialog(myMeetingSSS);
