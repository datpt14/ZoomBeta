...
public class RealNameAuthDialog extends Dialog implements View.OnClickListener, SmsListener {
    ...
    public static void show(MyMeetingActivity myMeetingSSS, IZoomRetrieveSMSVerificationCodeHandler handler) {

        RealNameAuthDialog dialog = new RealNameAuthDialog(myMeetingSSS);
